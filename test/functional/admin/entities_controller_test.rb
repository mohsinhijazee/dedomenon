...
class Admin::EntitiesControllerTest < Test::Unit::TestCase
...
#  end
  ...
  def test_unlink_detail_correct_detail
    ...
    #pre_details_count = Entities2Detail.count("entity_id=11")
    pre_details_count = Entities2Detail.count(:conditions => "entity_id=11")
    get :unlink_detail, { :id => "11", :detail_id => "55"}, { 'user' => User.find_by_id(@db1_admin_user_id)} 
    #post_details_count = Entities2Detail.count("entity_id=11")
    post_details_count = Entities2Detail.count(:conditions => "entity_id=11")
  ...
  def test_unlink_detail_not_own_detail
    #-------------------------------------------
    pre_details_count = Entities2Detail.count
    get :unlink_detail, { :id => "11", :detail_id => "35"}, { 'user' => User.find_by_id(@db1_admin_user_id)} 
    post_details_count = Entities2Detail.count
  ...
  #{"detail_id"=>"63", "action"=>"add_existing", "id"=>"11", "controller"=>"admin/entities", "status_id"=>"1", "displayed_in_list_view"=>"t", "display_order"=>"70"}
    def test_add_existing
      ...
      entity2detail = Entities2Detail.find(:first, :conditions=>"detail_id=60 and entity_id=11")
      assert_nil entity2detail
      pre_count = Entities2Detail.count
      
      post :add_existing, { :detail_id => 60, :id => 11, :status_id => 1, :displayed_in_list_view => 't'},{ 'user' => User.find_by_id(@db1_admin_user_id)}
      
      post_count = Entities2Detail.count
      #redirect correct?
      assert_response :redirect
      assert_redirected_to :action => "show", :id => "11"
    ...
    def test_add_existing_already_used
      ...
      #detail not used yet by entity
      entity2detail = Entities2Detail.find(:first, :conditions=>"detail_id=52 and entity_id=11")
